...
import ua.andrew1903.expensetracker.db.tables.Databasechangeloglock;
...
public class DatabasechangeloglockRecord extends UpdatableRecordImpl<DatabasechangeloglockRecord> implements Record4<Integer, Boolean, LocalDateTime, String> {
    ...
    /**
     * Setter for <code>expense_tracker.DATABASECHANGELOGLOCK.ID</code>.
     */
    ...
    /**
     * Getter for <code>expense_tracker.DATABASECHANGELOGLOCK.ID</code>.
     */
    ...
    /**
     * Setter for <code>expense_tracker.DATABASECHANGELOGLOCK.LOCKED</code>.
     */
    ...
    /**
     * Getter for <code>expense_tracker.DATABASECHANGELOGLOCK.LOCKED</code>.
     */
    ...
    /**
     * Setter for <code>expense_tracker.DATABASECHANGELOGLOCK.LOCKEDBY</code>.
     */
    ...
    /**
     * Getter for <code>expense_tracker.DATABASECHANGELOGLOCK.LOCKEDBY</code>.
     */
    ...
    public Field<Integer> field1() {
        return Databasechangeloglock.TABLE.ID;
    }

    @Override
    public Field<Boolean> field2() {
        return Databasechangeloglock.TABLE.LOCKED;
    }

    @Override
    public Field<LocalDateTime> field3() {
        return Databasechangeloglock.TABLE.LOCKGRANTED;
    }

    @Override
    public Field<String> field4() {
        return Databasechangeloglock.TABLE.LOCKEDBY;
    }
    ...
    public DatabasechangeloglockRecord() {
        super(Databasechangeloglock.TABLE);
    }
